...
const file_proto_user_proto_rawDesc = "" +
	...
	"\x12StreamUsersRequest2\xfb\x01\n" +
	"\vUserService\x126\n" +
	...
	"\tListUsers\x12\x16.user.ListUsersRequest\x1a\x17.user.ListUsersResponse\x125\n" +
	"\vStreamUsers\x12\x18.user.StreamUsersRequest\x1a\n" +
	".user.User0\x01B;Z9github.com/steviepreston/grpc-proto-example/proto-buffersb\x06proto3"
...
var file_proto_user_proto_depIdxs = []int32{
	...
	7, // 6: user.UserService.StreamUsers:input_type -> user.StreamUsersRequest
	...
	0, // 10: user.UserService.StreamUsers:output_type -> user.User
